...
class lstmweahter:
    ...
    def modeltrain(self, model, x_train, y_train, x_val, y_val):
        ...
        for i in range(100):
            model.fit(x_train, y_train, epochs=1, batch_size=1, shuffle=False, callbacks=[custom_hist, callbacks.EarlyStopping(patience=3, verbose=2)],
...
if __name__== "__main__":
    lstmweahter('weather_past.csv').run()