...
x_data = datas[['STT_N']].as_matrix()
y_data = datas[['DLY']].as_matrix()
y_data = [[1] if i=='N' else [0] for i in y_data]
...
W = tf.Variable(tf.random_normal([1,1]), name='weight')#두개의 변수(X1,X2)가 나오고 Y로 출력됨 ==> 2,1
